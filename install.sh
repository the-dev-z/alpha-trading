#!/bin/bash
#
# Alpha Trading One-Click Installation Script
# https://github.com/the-dev-z/alpha-trading
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/the-dev-z/alpha-trading/main/install.sh | bash
#
# Or with custom directory:
#   curl -fsSL https://raw.githubusercontent.com/the-dev-z/alpha-trading/main/install.sh | bash -s -- /opt/alpha-trading
#
...
INSTALL_DIR="${1:-$HOME/alpha-trading}"
COMPOSE_FILE="docker-compose.prod.yml"
GITHUB_RAW="https://raw.githubusercontent.com/the-dev-z/alpha-trading/main"

echo -e "${BLUE}"
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              Alpha Trading - Quantitative Platform         ║"
...
generate_env() {
    ...
    # Create .env file
    cat > .env << EOF
# Alpha Trading Configuration (Auto-generated)
...
# Start services
start_services() {
    echo -e "${YELLOW}Starting Alpha Trading services...${NC}"
    $COMPOSE_CMD up -d
...
print_success() {
    ...
    echo -e "╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "  ${GREEN}curl -fsSL https://raw.githubusercontent.com/the-dev-z/alpha-trading/main/install.sh | bash${NC}"
    echo ""
