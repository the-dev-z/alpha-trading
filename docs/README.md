# 📚 Alpha Trading Documentation Center / 文档中心

Welcome to the Alpha Trading documentation! This page helps you find the right documentation quickly.

欢迎来到 Alpha Trading 文档中心！本页面帮助您快速找到所需文档。

---

## 🚀 Getting Started / 快速开始

**New to Alpha Trading? Start here!**
...
**Learn how to use Alpha Trading effectively**
...
- 🐛 [Report Issues](https://github.com/the-dev-z/alpha-trading/issues)
...
**Alpha Trading's strategic development plan and market expansion**
...
- 🐛 **Report a bug** → [GitHub Issues](https://github.com/the-dev-z/alpha-trading/issues/new)
- 💡 **Suggest a feature** → [Feature Request](https://github.com/the-dev-z/alpha-trading/issues/new?template=feature_request.md)
- 🔒 **Report security issue** → [Security Policy](../SECURITY.md)
- 💰 **Claim a bounty** → [Bounty Guide](community/bounty-guide.md)
- 🤝 **Contribute code** → [Contributing Guide](../CONTRIBUTING.md)
- 💬 **Ask questions** → [Telegram Community](https://github.com/the-dev-z/alpha-trading/discussions)
...
2. **Join Telegram** - [Alpha Trading Developer Community](https://github.com/the-dev-z/alpha-trading/discussions)
3. **Ask on Twitter** - Mention [@the-dev-z](https://github.com/the-dev-z/alpha-trading)
4. **Create an Issue** - [New Issue](https://github.com/the-dev-z/alpha-trading/issues/new)
...
**Maintained by:** [Alpha Trading Community](https://github.com/NoFxAiOS)
