...
## 📋 Overview
We're looking for contributors to add Hyperliquid exchange support to Alpha Trading AI Trading System. Currently supports Binance Futures, seeking to expand to Hyperliquid perpetual contracts.
...
- Join our Telegram: [Alpha Trading Developer Community](https://github.com/the-dev-z/alpha-trading/discussions)
