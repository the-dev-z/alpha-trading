...
## Step 4: Configure in Alpha Trading

Add your agent wallet through the Alpha Trading web interface:
...
| Private Key | Only needed for Alpha Trading | `abc123...` (no 0x) |
