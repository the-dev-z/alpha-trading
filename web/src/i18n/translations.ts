...
export const translations = {
  en: {
    ...
    lighterApiKeyIndex: 'API Key Index',
    lighterApiKeyIndexDesc: 'API Key Index from Lighter website (0=desktop, 1=mobile, 2-254=user keys)',
  ...
  zh: {
    ...
    lighterApiKeyIndex: 'API Key 索引',
    lighterApiKeyIndexDesc: 'Lighter 網站上的 API Key 索引（0=桌面版, 1=移動版, 2-254=用戶密鑰）',
